...
<head>
    ...
    <style>
        ...
        <%@include file="assets/fonts/fontawesome-all.min.css"%>
        <%@include file="assets/fonts/font-awesome.min.css"%>
        <%@include file="assets/fonts/fontawesome5-overrides.min.css"%>
    </style>
</head>
...
<div id="wrapper">
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <div class="sidebar-brand-text mx-3"><span>UT1 Capitole</span></div>
        </a>
